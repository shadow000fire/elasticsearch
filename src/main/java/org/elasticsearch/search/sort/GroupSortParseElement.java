...
public class GroupSortParseElement implements SearchParseElement {
    ...
    public void parse(XContentParser parser, SearchContext context) throws Exception {
        ...
        if (!sortFields.isEmpty()) {
            ...
            if (sort) {
                context.groupSort(new Sort(sortFields.toArray(new SortField[sortFields.size()])));
            }
        }
    }
